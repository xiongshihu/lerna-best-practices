...
举个例子，如果你要维护两个package。分别为module-1,module-caowei。
下面是这两个package的依赖关系。
```
...
```
在这样的环境下，module-1是依赖module-caowei的。如果module-caowei有修改，需要发布。那么你的工作有这些。

 1. 修改module-caowei版本号，发布。
